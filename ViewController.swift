...
//    }
    ...
    func buildScenarios()
    {
        scenarios = [
            ...
            Scenario(description: "Grandma and Grandpa invite you over to play cards. Should you go?", goodEffect: "Happiness", badEffect: "Family Health", goodAmount: 0.2, badAmount: 0.30, probability: 0.80, yes: "You increased your happiness by playing cards!", yesYes: "However, you were carrying the virus and got Grandma and Grandpa sick. They are in the high risk category! Health of family will suffer...", no:  "Not playing cards has hurt your happiness...  However, you didn't get your Grandma and Grandpa sick so your family health has increased!"),
            Scenario(description: "Your friends invite you to play beach volleyball.  Do you go?", goodEffect: "Happiness", badEffect: "Nation Health", goodAmount: 0.1, badAmount: 0.10, probability: 0.30, yes: "You increased your happiness by going to the park!", yesYes: "However, you contracted the corona virus at the park.  Your family health will suffer...", no:  "Not playing volleyball has hurt your happiness...  However, you didn't spread the virus so the Nation Health has improved!"),
                  Scenario(description: "It's St. Patrick's Day!  Your friends are celebrating at the Park.  Do you go?", goodEffect: "Happiness", badEffect: "Family Health", goodAmount: 0.1, badAmount: 0.30, probability: 0.70, yes: "You increased your happiness by going to the park!", yesYes: "However, you contracted the corona virus at the park.  Your family health will suffer...", no:  "Not going to the park has hurt your happiness...  However, you didn't get sick so your family health has increased!"),
                        Scenario(description: "You won free tickets to Italy!  Do you go?", goodEffect: "Happiness", badEffect: "Nation Health", goodAmount: 0.1, badAmount: 0.20, probability: 0.90, yes: "You increased your happiness by going to Italy!", yesYes: "However, you contracted the virus and have spread it to many people.  Nation health will suffer...", no:  "Not going to Italy has hurt your happiness...  However, you didn't contribute to the spread of the virius.  Nation Health has improved!"),
                                 Scenario(description: "Your friend just called you a wimp for staying quarantined.  You have a desire to go TP their house.  Do you go?", goodEffect: "Happiness", badEffect: "Toilet Paper", goodAmount: 0.1, badAmount: 0.1, probability: 1.0, yes: "You increased your happiness by TP-ing your friends house!", yesYes: "However,  you lost a bunch of toilet paper.  Toilet Paper stock has suffered...", no:  "Not TP-ing your friends house has hurt your happiness...  However, you helped your toilet paper stock!"),
                                          Scenario(description: "The blood bank needs blood.  Do you go?", goodEffect: "Nation Health", badEffect: "Family Health", goodAmount: 0.1, badAmount: 0.1, probability: 0.1, yes: "You improved the nation health by giving blood", yesYes: "However, you somehow contracted the virus.  Family health will suffer...", no:  "Not giving blood has hurt the nation's health... However, you kept your family from the virus.  Family health has improved!"),
                                                   Scenario(description: "A local food shelter needs volunteers to help hand out food.  Do you go?", goodEffect: "Nation Health", badEffect: "Family Health", goodAmount: 0.1, badAmount: 0.1, probability: 0.3, yes: "You improved the Nation Health by volunteering at the food shelter!", yesYes: "However, you somehow contracted the virus.  Family health will suffer...", no:  "Not helping out at the shelter has hurt the Nation's health...  However, you kept your family from the virus.  Family health has improved!"),
                                                             Scenario(description: "You have plans to fly to Florida for spring break.  Do you go?", goodEffect: "Happiness", badEffect: "Nation Health", goodAmount: 0.2, badAmount: 0.15, probability: 0.5, yes: "You increased your happiness by going on Spring Break!", yesYes: "However, you contracted the virus and have spread it to many people.  Nation health will suffer...", no:  "Not going on spring break has hurt your happiness...  However, you helped not spread the virus.  Nation Health has improved!"),
                                                                      Scenario(description: "You really only get a good workout at the gym.  Do you go?", goodEffect: "Family Health", badEffect: "Family Health", goodAmount: 0.1, badAmount: 0.3, probability: 0.4, yes: "You increased your family health by getting a good workout in! ", yesYes: "However, you also contracted the virus at the gym.  Family Health has now suffered...", no:  "Not going to the gym has hurt your family heath.  However, you also didn't get the virus so you actually improved your family health!!"),
                                                                       Scenario(description: "You haven't seen your friends in a long time and they are going to meet at the park.  Do you go?", goodEffect: "Happiness", badEffect: "Nation Health", goodAmount: 0.2, badAmount: 0.1, probability: 0.4, yes: "You increased your happiness by going to the park!  ", yesYes: "However, you were carrying the virus and got others sick.  Health of nation will suffer...", no:  "Not going to the park has hurt your happiness...  However, the virus does not have a chance to spread.  Nation Health has improved!"),
                                                                       Scenario(description: "You are sick of being in the house!  You want to go shopping.  Do you go?", goodEffect: "Happiness", badEffect: "Family Health", goodAmount: 0.15, badAmount: 0.2, probability: 0.3, yes: "You increased your happiness by going shopping!", yesYes: "However, you contracted the virus.  Family health will suffer...", no:  "Not going shopping has hurt your happiness...  However, your family health has improved!"),
